  ...
  <div id="CorporateProfile">
    <el-container id="top-img">
        ...
        <el-col :span="15" style="background-color: #345771;height: 100%">
          <el-row type="flex" justify="start" style="padding: 10px">
            ...
            <el-col :span="20" style="margin-top: 5px;margin-left: 5px;text-shadow: 2px 2px 5px white">
              ...
              <p style="font-size: 30px;color: white;text-shadow: none;font-weight: bolder;margin-right: 28%">山东亚历山大智能科技有限公司</p>
            </el-col>
          </el-row>
        </el-col>
        <el-col :span="9"
      ...
      <el-footer style="background-color: #0d64e8">
        <p style="font-size: 30px;font-weight: bolder;color: white;margin-top: 10px;margin-bottom:0;margin-left: 5%">公司介绍</p>
      </el-footer>
    </el-container>
    <el-container>
      <el-main style="color: #0D64E8;font-size: 18px">
        <div>
          ...
          <el-row :gutter="24" style="background-color: #f2f6fa">
            <el-col :span="1">
              <br>
            </el-col>
            <el-col :span="12">
              <div>
                <el-row style="font-size: 32px;font-weight: bold">
                  科研实力
                </el-row>
                <el-row>
                  <br>
                    ...
                    <el-tab-pane label="权威授权" name="first">
                      <div>
                        <el-row :gutter="24">
                          ...
                          <el-col :span="5">
                            <br><br><br><br>
                            <img src="static/img/Contact/u3345.png">
                          </el-col>
                          <el-col :span="5">
                            <br><br><br><br>
                            <img src="static/img/Contact/u3344.png">
                          </el-col>
                          <el-col :span="3">
                            <br><br><br>
    ...
    <el-container id="bottom">
      <el-main style="background: #0d64e8;font-size: 25px">
        <el-row :gutter="24">
          <el-col :span="10" style="color: white;text-align: left;font-weight: bold">
            欢迎致电我们
          </el-col>
          <el-col :span="2">
          </el-col>
