...
<template>
  <div id="news">
    ...
    <el-row class="content">
      <el-col class="new-item" :span="7">
        <div style="height: 12rem;background: url('../../static/temp.png') no-repeat;background-size: 100% 100%;">
        </div>
        <h4 class="newtitle">{{ '第一个新闻' }}</h4>
        <p class="newcontent">{{ '这是新闻的介绍' }}</p>
        <p class="btn">
          <i class="el-icon-caret-right">
            <span class="newsbtn">更多</span>
          </i>
        </p>
      </el-col>
      <el-col class="new-item" :span="7">
