                ...
                <el-carousel-item v-for="item in 3" :key="item"  >
                    ...
                    <div v-if="item===2">
                        ...
                        <el-row :gutter="24">
                            ...
                            <el-col :span="8">
                                <img src="../../static/img/OpenCommunity/u981.png"  @click="showDialog(item)" style="width: 1400px;height: 800px">
                            </el-col>
                            <el-col :span="12">
                                <br>
                            </el-col>
                    ...
                    <div v-if="item===3">
                        ...
                        <el-row :gutter="24">
                            ...
                            <el-col :span="10">
                                <img src="../../static/img/OpenCommunity/u985.jpg" @click="showDialog(item)" style="width: 900px;height: 800px;">
                            </el-col>
                            ...
                            <div>
                                <el-row :gutter="24" style="background-color: rgba(223, 235, 251, 1)">
                                    ...
                                    <el-col :span="12">
                                        <div style="font-size: 16px">
                                            <el-row><br></el-row>
                                            <el-row>
                                                建筑智能机器人&nbsp;&nbsp;隧道检测机器人&nbsp;&nbsp; 激光清洗机器人
                                            </el-row>
                                            <el-row><br></el-row>
                                            <el-row>
                                                工业设备&nbsp;&nbsp; 搬运机器人 &nbsp;&nbsp;背负系列 &nbsp;&nbsp;顶升系列&nbsp;&nbsp;
                                                叉车系列
                                                &nbsp;&nbsp;物流运输线 &nbsp;&nbsp;牵引系列
                                            </el-row>
                                            <el-row><br></el-row>
                                            <el-row>
                                                服务机器人 &nbsp;&nbsp;消毒机器人 &nbsp;&nbsp;送餐机器人 &nbsp;&nbsp;送药机器人&nbsp;&nbsp;
                                                迎宾机器人
                                            </el-row>
                                            <el-row><br></el-row>
                                        </div>
                                ...
                                <el-row :gutter="24" style="background-color: rgba(209, 222, 237, 1)">
                                    ...
                                    <el-col :span="5">
                                        <div style="font-size: 20px;">
                                            ...
                                            <el-row> 大数据平台</el-row>
                                            <el-row><br></el-row>
                                            <el-row> 场景服务软件系统</el-row>
                                            <el-row><br></el-row>
                                            <el-row> 硬件控制与驱动系统</el-row>
                                            <el-row><br></el-row>
                                        </div>
                                    </el-col>
                                    <el-col :span="12">
                                        <el-row>
                                            <div style="font-size: 16px">
                                                ...
                                                <el-row><br></el-row>
                                                <el-row>
                                                    云端管理控制&nbsp;&nbsp;云端地图构建&nbsp;&nbsp;云端定位计算&nbsp;&nbsp;云端任务管理&nbsp;云端路线规划
                                                </el-row>
                                                <el-row>
                                                    云端数据分析&nbsp;&nbsp;云端数据可视化&nbsp;&nbsp;云端视觉识别&nbsp;&nbsp;云端语音识别&nbsp;&nbsp;云端广告推送&nbsp;&nbsp;云端系统更新
                                                </el-row>
                                            </div>
                                        </el-row>
                                        <el-row><br></el-row>
                                        <el-row>
                                            数据集成&nbsp;&nbsp;数据存储&nbsp;&nbsp;数据开发 &nbsp;&nbsp;数据治理&nbsp;&nbsp;数据资产&nbsp;&nbsp;数据服务
                                        </el-row>
                                        <el-row><br></el-row>
                                        <el-row>
                                            工业信息化系统 &nbsp;&nbsp;ERP&nbsp;&nbsp; MES &nbsp;&nbsp; WMS &nbsp;&nbsp;WCS
                                        </el-row>
                                        <el-row><br></el-row>
                                        <el-row>
                                            <div>
                                ...
                                <el-row :gutter="24" style="background-color: rgba(223, 235, 251, 1)">
                                    ...
                                    <el-col :span="5">
                                        <div style="font-size: 20px;">
                                            <el-row><br></el-row>
                                            <el-row>协同研发合作</el-row>
                                            <el-row><br></el-row>
                                            <el-row>供应商合作</el-row>
                                            <el-row><br></el-row>
                                            <el-row>教育培训合作</el-row>
                                            <el-row><br></el-row>
                                        </div>
                                    </el-col>
                                    <el-col :span="12">
