      ...
      <el-row style="width: 100%;height:400px;">
        <el-col :span="13" style="background-color: #010f1b;height: 100%">
          <el-row type="flex" justify="start" style="padding: 10px">
            <el-col :span="3" style="margin-right: 100px">
    ...
    <div>
      ...
      <el-row style="margin-bottom: 2%">
        <el-col style="width:100%;margin-left: 6%">
          <el-row>
            <p style="font-size: 32px;font-weight: bolder;color: #0d64e8">AGV调度系统</p>
          </el-row>
          <el-row style="text-align: left;height: 100%">
            <el-col :span="12" style="margin-left: 5%;margin-right: 2%">
              <el-row
                ...
                保障整个系统运行的可靠性。<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在整个工厂生产制造过程中，AGV调度系统可以与MES(制造执行系统)、ERP内部管理系统等进行数据交换实现无缝对接。
      ...
      <el-row style="background-color: white">
        <el-col style="width:100%;margin-left: 6%;margin-bottom:2%">
          <el-row>
            <p style="font-size: 32px;font-weight: bolder;color: #0d64e8">WMS智能仓储管理系统</p>
          </el-row>
          <el-row style="text-align: left;height: 100%">
            <el-col :span="12" style="margin-left: 5%;margin-right: 2%">
              <el-row
      ...
      <el-row style="margin-bottom: 2%">
        <el-col style="width:100%;margin-left: 6%">
          <el-row>
            <p style="font-size: 32px;font-weight: bolder;color: #0d64e8">MES制造执行系统</p>
          </el-row>
          <el-row style="text-align: left;height: 100%">
            <el-col :span="12" style="margin-left: 5%;margin-right: 2%">
              <el-row
      ...
      <el-row style="background-color: white;margin-bottom: 2%">
        <el-col style="width:100%;margin-left: 6%;margin-bottom:2%">
          <el-row>
            <p style="font-size: 32px;font-weight: bolder;color: #0d64e8">ERP企业资源计划管理系统</p>
          </el-row>
          <el-row style="text-align: left;height: 100%">
            <el-col :span="12" style="margin-left: 5%;margin-right: 2%">
              <el-row
      ...
      <el-row>
        <el-col style="width:100%;margin-left: 6%;margin-bottom:2%">
          <el-row>
            <p style="font-size: 32px;font-weight: bolder;color: #0d64e8">数字化工厂管理系统</p>
          </el-row>
          <el-row style="text-align: left;height: 100%">
